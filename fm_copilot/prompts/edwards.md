...
# Structure
Follow the section order in the user message exactly. Nine sections, numbered as given. Do not add sections. Do not merge sections. Open with the title line.
